...
class streambuf : public std::basic_streambuf<char>
{
  ...
  private:
    ...
    */
	...
	std::runtime_error("Control flow passes through branch that should be unreachable.");
      }
...
//namespace pybind11 {
  namespace detail {
    ...
    public:
      ...
      static constexpr auto name = _("istream"); // THIS LINE WAS CHANGED IN VERSION 2.2.2
    ...
    public:
      ...
      static constexpr auto name = _("ostream"); // THIS LINE WAS CHANGED IN VERSION 2.2.2
